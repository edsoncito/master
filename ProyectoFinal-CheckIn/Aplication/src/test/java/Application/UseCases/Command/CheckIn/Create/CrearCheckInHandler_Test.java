...
public class CrearCheckInHandler_Test {
    ...
    public void HandleCorrectly() throws HttpException {
        ...
        CheckIn objCheckIn = new CheckInFactory().Create(CodigoSeguridad, EstadoPaciente, Descripcion, Asiento);
        when(checkInFactory.Create( anyString(), anyBoolean(), anyString(), anyInt())).thenReturn(objCheckIn);
